...
public class ConsultarPartidos extends JFrame implements ActionListener {
    ...
    public ConsultarPartidos(Controller cont, String entrConnected) {
        ...
        scrollPane.setBounds(253, 10, 731, 660);
        ...
        ImageIcon imgIcon2 = new ImageIcon(getClass().getResource("/images/equiposLogo/real-madrid.png"));

        String logo1 = "/images/equiposLogo/athletic-bilbao.png";
        String logo2 = "/images/equiposLogo/real-madrid.png";

        showPartidoInfo("athletic de bilbao", logo1, "real madrid", logo2, "17-04-2024 16:15", "Bilbao", 20);
        showPartidoInfo("athletic 1 ", logo1, "real 1", logo2, "17-04-2024 16:15", "Bilbao", 20 + 180);
        showPartidoInfo("athletic 2 ", logo1, "real 2", logo2, "17-04-2024 16:15", "Bilbao", 20 + 180 * 2);
        showPartidoInfo("athletic 3 ", logo1, "real 3", logo2, "17-04-2024 16:15", "Bilbao", 20 + 180 * 3);
        showPartidoInfo("athletic 4 ", logo1, "real 4", logo2, "17-04-2024 16:15", "Bilbao", 20 + 180 * 4);
        showPartidoInfo("athletic 5 ", logo1, "real 5", logo2, "17-04-2024 16:15", "Bilbao", 20 + 180 * 5);
    }

    public void showPartidoInfo(String eqLocal, String linkLogo1, String EqVisitante, String linkLogo2, String dateTime, String estadio, int high) {
        JPanel partidoPanel = new JPanel();
        partidoPanel.setForeground(new Color(255, 128, 64));
        partidoPanel.setBackground(new Color(192, 192, 192));
        partidoPanel.setBounds(10, high, 718, 170);
        rightPanel.add(partidoPanel);
