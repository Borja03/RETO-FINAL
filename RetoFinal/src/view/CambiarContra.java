...
public class CambiarContra extends JFrame implements ActionListener {
	...
	public CambiarContra(Controller controlador, String userName, String userType) {
		...
		panelLeft1.setBackground(new Color(128, 128, 0));
		panelLeft1.setBounds(0, 0, 345, 680);
		contentPane.add(panelLeft1);
		...
		panelLeft1.add(btnCambiarDorsal);
		...
		panelLeft1.add(btnConsultarPartidos);
		...
		panelLeft1.add(btnConsultarEquipo);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnLogOut) {
			...
			GestionarJugadores g1 = new GestionarJugadores(controller, userName, userType, userName);
			g1.setVisible(true);
			this.dispose();
